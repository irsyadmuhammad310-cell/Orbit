...
var Settings = {
  render: function() {
    document.getElementById('pg-settings').innerHTML = '<div class="pg-h"><div class="back" onclick="App.go(\'more\')">←</div><div class="pg-t" style="flex:1">Settings</div></div>' +
      ...
      '<div class="set"><div class="set-h">About</div><div class="set-r"><span class="set-l">Version</span><span class="set-v">1.5.0</span></div><div class="set-r"><span class="set-l">Tasks</span><span class="set-v">' + DB.getAll('tasks').length + '</span></div><div class="set-r"><span class="set-l">Projects</span><span class="set-v">' + DB.getAll('projects').length + '</span></div></div>';
  },
