...
var Settings = {
  render: function() {
    document.getElementById('pg-settings').innerHTML = '<div class="pg-h"><div class="back" onclick="App.go(\'more\')">←</div><div class="pg-t" style="flex:1">Settings</div></div>' +
      ...
      '<div class="set"><div class="set-h">System</div><div class="set-r" onclick="Settings.checkForUpdates()"><span class="set-l">Check for Updates</span><span class="set-v">🔄</span></div><div class="set-r" onclick="Notif.requestPermission()"><span class="set-l">Push Notifications</span><span class="set-v">' + (typeof Notif !== 'undefined' && Notif.granted ? '✅ On' : '🔕 Off') + '</span></div></div>' +
